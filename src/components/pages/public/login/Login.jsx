...
export default function Login() {
  return (
    <div className='login'>
        ...
        <div className="row">
            <div className="col text_ctn pt-5">
